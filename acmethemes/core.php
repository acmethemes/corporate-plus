...
if ( ! function_exists( 'corporate_plus_setup' ) ) :
	...
	function corporate_plus_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'corporate_plus_custom_background_args',
				array(
...
function corporate_plus_scripts() {
	...
	wp_style_add_data( 'corporate-plus-style', 'rtl', 'replace' );
	...
	/*Bxslider*/
	wp_enqueue_script( 'jquery-bxslider', get_template_directory_uri() . '/assets/library/bxslider/js/jquery.bxslider.js', array( 'jquery' ), '4.2.5.1', 1 );
