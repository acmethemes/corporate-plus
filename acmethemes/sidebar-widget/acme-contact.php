...
if ( ! class_exists( 'Corporate_plus_contact' ) ) {
    ...
    class Corporate_plus_contact extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'shortcode' ) ); ?>"><?php _e( 'Enter Shortcode', 'corporate-plus' ); ?>:</label>
                ...
                <small>
                    <?php
                    printf( __( 'Download contact form 7 from %1$s here %2$s', 'corporate-plus' ), "<a target='_blank' href='".esc_url( 'https://wordpress.org/plugins/contact-form-7/' )."''>","</a>" );
                    ?>
                </small>
            </p>
            <p>
                ...
                ?>
                <span class="img-preview-wrap" <?php echo esc_attr( $corporate_plus_display_none ); ?>>
        ...
        public function widget($args, $instance) {
            ...
            <section id="<?php echo esc_attr( $unique_id ); ?>">
                <div class="featured-section at-parallax contact-form" style="<?php echo esc_attr( $bg_image_style ); ?>">
