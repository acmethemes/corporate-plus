...
if ( ! class_exists( 'Corporate_plus_about' ) ) {
    ...
    class Corporate_plus_about extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php _e( 'Select Parent Page For About', 'corporate-plus' ); ?>:</label>
                <br />
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'column_number' ) ); ?>"><?php _e( 'Column Number', 'corporate-plus' ); ?>:</label>
