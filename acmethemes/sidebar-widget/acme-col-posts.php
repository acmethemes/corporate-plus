...
if ( ! class_exists( 'corporate_plus_posts_col' ) ) {
    ...
    class corporate_plus_posts_col extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'unique_id' ) ); ?>"><?php _e( 'Section ID', 'corporate-plus' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title', 'corporate-plus' ); ?>:</label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo $title; ?>" />
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'corporate_plus_cat_id' ) ); ?>"><?php _e('Select Category', 'corporate-plus'); ?></label>
                <?php
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'post_number' ) ); ?>"><?php _e( 'Post Number', 'corporate-plus' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><?php _e( 'Button Text', 'corporate-plus' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_url' ) ); ?>"><?php _e( 'Button Link Url', 'corporate-plus' ); ?>:</label>
