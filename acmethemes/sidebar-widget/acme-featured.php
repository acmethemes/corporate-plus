...
if ( ! class_exists( 'Corporate_plus_featured' ) ) {
    ...
    class Corporate_plus_featured extends WP_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><?php _e( 'Description', 'corporate-plus' ); ?>:</label>
        ...
        public function widget($args, $instance) {
            ...
            ?>
            <section id="<?php echo esc_attr( $unique_id ); ?>" class="<?php echo esc_attr( $bg_image_class ); ?>" style="<?php echo esc_attr( $bg_image_style ); ?>">
